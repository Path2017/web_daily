...
$(function () {
  ...
  var currentDay = day.getFullYear() + '-' + month + '-' + day.getDate();
  $('.date_picker').val(currentDay);
  $('#pqsenstep').click(function () {
    // window.location.href = './post_requirement_step3.html'
    var dstype1 = $('#dstype1').find('.nowselect').length;
    var dstype3 = $('#dstype3').find('.nowselect').length;
    var dstype4 = $('#dstype4').find('.nowselect').length;
