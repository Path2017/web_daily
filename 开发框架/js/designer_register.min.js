...
$(function () {
  ...
  $('#firstStep').click(function () {
    $('#registerform').parsley().whenValidate({
      ...
      var checkbox = $('.ischeck').is(':checked');
      if (!checkbox) {
  ...
  $('#secondStep').click(function () {
    var len = $('.worksimg-ul li').length;
    var num = 0;
    var frontId = $('.front-id').val();
    var backendId = $('.backend-id').val();
    for (var i = 0; i < len; i++) {
      var inputVal = $('.worksimg-ul li').eq(i).find('input').val();
      if (inputVal !== '') {
        num++;
      }
    }
  ...
  var success = '<i class="success-icon2"></i>';
  $('#registerform').parsley().on('field:success', function () {
